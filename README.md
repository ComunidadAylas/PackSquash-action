...
| Parameter | Default value | Description |
|---|---|---|
| `packsquash_version` | `v0.3.0` | The PackSquash version the action will use. Please note that too old or too new versions may be incompatible or not properly supported by the action. |
