...
| [allow_optifine_mods](https://github.com/ComunidadAylas/PackSquash/wiki/Settings-file-format#allowed_mods) | `false` | Add support for .properties files. From version 0.3.0 onwards, it also adds .jpm and .jem for proper Custom Entity Models support. |
...
| Option | Default | Description |
|---|---|---|
| setting_file | **required** | Use the specified settings file instead of generating one with this action. Please read [here](https://github.com/ComunidadAylas/PackSquash/wiki/Settings-file-format). |
